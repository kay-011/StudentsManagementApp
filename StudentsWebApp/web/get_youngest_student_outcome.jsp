<%-- 
    Document   : get_youngest_student_outcome
    Created on : 06 May 2025, 10:09:02 PM
    Author     : KHOTHATSO
--%>
...
<html>
    <head>
        ...
        <title>Get Youngest Student Outcome Page</title>
    </head>
    <body>
        <h1>Get Youngest Student Outcome</h1>
        <%
            Student s = (Student) request.getAttribute("student");

        %>
        <p>
            View The Youngest Student Outcome below:
        </p>
        <table>
            <tr>
                <td>
